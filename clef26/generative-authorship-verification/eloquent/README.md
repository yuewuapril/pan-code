...
# Generative AI Authorship Verification 2026: Eloquent Set
...
```
tira-cli dataset-submission --path eloquent --task generative-ai-authorship-verification-panclef-2026 --split test --dry-run
```
